...
class GovermentPositionPage extends StatefulWidget {
  @override
  State<GovermentPositionPage> createState() => _GovermentPositionState();
}

class _GovermentPositionState extends State<GovermentPositionPage> {
  String? chooseValue;
                  ...
                  child: ListView(
                    children: [
                      PaginatedDataTable(
                        ...
                        source: _data,
                        header: Text('goverment_position'.tr),
                        columnSpacing: 2,
                      ),
                    ],
                  ),
