...
class OrganizationPositionPage extends StatefulWidget {
  @override
  State<OrganizationPositionPage> createState() => _OrganizationPositionPageState();
}

class _OrganizationPositionPageState extends State<OrganizationPositionPage> {
  String? chooseValue;
                  ...
                  child: ListView(
                    children: [
                      PaginatedDataTable(
                        ...
                        source: _data,
                        header: Text('organization_position'.tr),
                        columnSpacing: 2,
                      ),
                    ],
                  ),
